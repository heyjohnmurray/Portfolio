			...
			<div class="body-copy">
				<div class="row">
					<div class="column small-12">
						<h1>Beating the Existing Stalwart Design</h1>
						<p>To provide a little bit of background, let me start off by saying that I was on the Red Ventures Insurance business from the beginning. In fact, when we partnered with Safeco several years ago, I was given the chance to be the principal designer and coder on that account.</p>
			...
			<div class="body-copy">
				<div class="row">
					<div class="column">
						...
						<h4>Promoting the Lead Form on "Sticky" header</h4>

						<p>Weeding out existing customers was critical to the insurance business because we couldn't sell anything to existing Safeco customers. All they did was hurt our conversion numbers every month.</p>
